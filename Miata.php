...
<body class="bg-maroon">
    ...
    <main class="container d-flex justify-content-center mt-4">
        <img src="../ecommerce/src/img/Miata.PNG" class="m-4" height="500px" width="350px" alt="">       
            <div class="container-fluid row" style="width: 30%;">
                ...
                <!-- card end -->
                <div class="col-12 text-white" style="font-size: 17px;">
                    <p>Longwait is over! Add this to your wardrobe! 

Cop the "Miata Chrome Tee" available on our online shop Lazada and Shopee
With free 2 stickers every purchase 
<br><br>
