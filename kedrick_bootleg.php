...
<body class="bg-maroon">
    ...
    <main class="container d-flex justify-content-center mt-4">
        <img src="../ecommerce/src/img/Kendrick B.png" class="m-4" height="470px" width="350px" alt="">       
            <div class="container-fluid row" style="width: 30%;">
                ...
                <!-- card end -->
                <div class="col-12 text-white" style="font-size: 18px;">
                    <p>Coozy's Bootleg Tee
                        Free Shipping Nationwide 🛒<br>
                        📌 Free Stickers Every purchase<br> 
                        📌 High Quality full print<br>
                        📌 Oversized<br>
