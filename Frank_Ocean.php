...
<body class="bg-maroon">
    ...
    <main class="container d-flex justify-content-center mt-4">
        <img src="../ecommerce/src/img/Frank.PNG" class="m-4" height="500px" width="350px" alt="">       
            <div class="container-fluid row" style="width: 30%;">
                ...
                <div class="col-12 text-white" style="font-size: 15px;">
                    <p>Coozy's Bootleg Tee
Free 2 Stickers every purchase
High quality full print <br><br>
