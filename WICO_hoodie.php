...
<body class="bg-maroon">
    ...
    <main class="container d-flex justify-content-center mt-4">
        <img src="../ecommerce/src/img/WICO.PNG" class="m-4" height="500px" width="350px" alt="">       
            <div class="container-fluid row" style="width: 30%;">
                ...
                <!-- card end -->
                <div class="col-12 text-white" style="font-size: 15px;">
                    <p>Introducing the Hoodie Doodle inspired "WICO" (Cold on the Outside, Warm on the Inside)! You will undoubtedly need it in your wardrobe. Congenial fit perfect for any street style, selected the most beefy, chunky, and dura-heavy fabric. This is a must-have hoodie!<br><br>

FREE 2 STICKERS EVERY PURCHASE<br><br>
