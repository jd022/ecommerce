...
<?php
    ...
    // accept search script
    if(isset($_GET['a']) && isset($_GET['s']) && isset($_GET['oid'])){
        ...
        // Use openssl_decrypt() function to decrypt the data
        $decryption_status = openssl_decrypt ($_GET['s'], $ciphering,
        $decryption_key, $options, $decryption_iv);

        if($decryption_status == 'Pending'){
            $status = 'Confirm';
        }else if($decryption_status == 'Confirm'){
            $status = 'To Deliver';
        }else if($decryption_status == 'To Deliver'){
            $status = 'Done';
        }
